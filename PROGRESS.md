...
| | |
|---|---|
| **URL** | **https://terrafunded-quest-v2.vercel.app** — live (deployed 2026-09-11 via Option B in **`DEPLOY.md`** with `VERCEL_TOKEN`; last `npm run verify:live` after the reservations deploy: net profit **$2,236,378**, trapped **$1,103,375**, "You need 8.44 lots/month; you are doing 4.73.", deep link `/pipeline` 200, all three themes persist; the Throne Room screenshots in `docs/live-*.jpg` show the Committed counter — 33 live reservations, $1,648,393 of $2,197,857 at stake, expected by Dec 2026 — the two pace lines and the This-month strip with September's **7** reservations, see OPEN_QUESTIONS #69). |
