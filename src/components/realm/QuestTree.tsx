 ...
 * how far along it is; the rest wait, locked.
 */
          ...
          <li key={n.id} className="flex basis-1/5 flex-col items-center gap-1.5 text-center sm:min-w-[56px] sm:flex-1 sm:basis-auto">
            <div className="flex w-full items-center">
              ...
              <motion.div
                ...
                className={cn(
                  "relative flex h-9 w-9 shrink-0 items-center justify-center rounded-full border text-[11px] font-semibold",
                  n.reached
              ...
              >
                ...
                {i === nextIndex && (
                  <svg className="absolute inset-0 -rotate-90" viewBox="0 0 36 36" aria-hidden>
                    <circle cx="18" cy="18" r="16.5" fill="none" stroke="hsl(var(--gold))" strokeWidth="2" strokeDasharray={`${(within / 100) * 103.7} 103.7`} strokeLinecap="round" />
                  </svg>
                )}
              </motion.div>
