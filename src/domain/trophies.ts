...
const TROPHY_COPY: Record<string, { title: Record<QualityLang, string>; description: Record<QualityLang, string> }> = {
  ...
  net_profit_1m: { title: { en: "$1M net profit at closing", es: "$1M de utilidad neta al cierre" }, description: { en: "Cumulative net profit at closing crosses $1,000,000.", es: "La utilidad neta al cierre acumulada cruza $1,000,000." } },
  net_profit_2m: { title: { en: "$2M net profit at closing", es: "$2M de utilidad neta al cierre" }, description: { en: "Cumulative net profit at closing crosses $2,000,000.", es: "La utilidad neta al cierre acumulada cruza $2,000,000." } },
  net_profit_5m: { title: { en: "$5M net profit at closing", es: "$5M de utilidad neta al cierre" }, description: { en: "Cumulative net profit at closing crosses $5,000,000.", es: "La utilidad neta al cierre acumulada cruza $5,000,000." } },
  net_profit_10m: { title: { en: "Exodus", es: "Exodus" }, description: { en: "Reach $10,000,000 of net profit at closing. The fund closes.", es: "Alcanza $10,000,000 de utilidad neta al cierre. El fondo cierra." } },
