...
export const ENGINE_UI: Record<QualityLang, EngineUiStrings> = {
  en: {
    ...
    inventoryProfit: "Net profit at closing if inventory sells",
    inventoryMonths: "Months inventory lasts at pace",
    lotsProduced: "Lots produced before deadline",
    turns: "Capital turns",
    netNoFresh: "Net profit at closing with no new capital",
    shortfall: "Shortfall",
    ...
    interestBesideVerdict: (interest, share) =>
      `${interest} of every turn goes to sponsor interest — ${share} of the net profit at closing this projection produces. More turns mean more interest; that is the strongest argument against simply adding another cycle.`,
  ...
  es: {
    ...
    interestBesideVerdict: (interest, share) =>
      `${interest} de cada giro se va en interés a sponsors — ${share} de la utilidad neta al cierre que produce esta proyección. Más giros significan más interés; ese es el argumento más fuerte contra simplemente añadir otro ciclo.`,
