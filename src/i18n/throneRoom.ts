...
export const THRONE_ROOM_UI: Record<QualityLang, ThroneRoomUiStrings> = {
  en: {
    ...
    verdictLotsMonthAnnotated: "lots/month from the closed-lot average",
    thisMonthAria: "This month",
    reservationsThisMonth: "Reservations this month",
    pledgedIn: (m) => `reserved in ${m}`,
    ...
    debtOxygenAria: "Capital owed and pace",
    ...
    months: (n) => `${n} months`,
    projected: ", projected",
    noFarmFreed: "no farm has returned capital, none projectable",
    farmsFunded: (since) => ` · farms funded ${since}`,
    freedEarlier: (names) => ` (${names} returned capital earlier, on record only)`,
    turnsCompleted: "Turns completed",
    farmFreed: "farm paid off",
    farmsFreed: "farms paid off",
    ...
    peakInWarPlan: (peak, farms, word, outstanding) =>
      `${peak} peak in the Plan buy schedule across ${farms} ${word} (not today's ${outstanding} already outstanding with sponsors)`,
    ...
    everyFarmFree: "every sponsor-funded farm has returned its capital",
    ...
    cashReconcile: (realized, other, total) =>
      `Farm-lot cash only. Cash realized ${realized} + other note sales ${other} = Cash flow in ${total}`,
    ...
    pipelineHint: (reserved, committed, conv, label, stuck) =>
      `${reserved} reserved lots, if every one closes as priced · ${committed} committed at ${conv} ${label} · ${stuck} stuck reservations`,
    capitalOutstandingKey: "Capital outstanding",
    captiveSponsor: "Today's sponsor capital still out",
    ownCapitalTied: (a) => ` · + ${a} own capital tied up`,
    liveChronicle: "Recent activity",
    fullChronicle: "Full activity",
  ...
  es: {
    ...
    verdictLotsMonthAnnotated: "lotes/mes del promedio de lotes cerrados",
    thisMonthAria: "Este mes",
    reservationsThisMonth: "Reservas este mes",
    pledgedIn: (m) => `reservó en ${m}`,
    ...
    debtOxygenAria: "Capital adeudado y ritmo",
    ...
    noFarmFreed: "ninguna finca ha devuelto capital, ninguna proyectable",
    farmsFunded: (since) => ` · fincas fondeadas ${since}`,
    freedEarlier: (names) => ` (${names} devolvieron capital antes, solo en el registro)`,
    turnsCompleted: "Ciclos completados",
    farmFreed: "finca pagada",
    farmsFreed: "fincas pagadas",
    ...
    peakInWarPlan: (peak, farms, word, outstanding) =>
      `${peak} de pico en el calendario de compras del Plan en ${farms} ${word} (no los ${outstanding} ya pendientes con sponsors hoy)`,
    ...
    everyFarmFree: "toda finca fondeada por sponsors ya devolvió su capital",
    ...
    cashReconcile: (realized, other, total) =>
      `Solo efectivo de lotes de finca. Efectivo realizado ${realized} + otras ventas de pagarés ${other} = Entrada de flujo de efectivo ${total}`,
    profitOnPaper: "Utilidad en papel",
    profitOnPaperHint: "Utilidad neta reconocida pero aún no en efectivo",
    pipelineProfit: "Utilidad en reservas",
    pipelineHint: (reserved, committed, conv, label, stuck) =>
    ...
    captiveSponsor: "Capital de sponsors aún afuera hoy",
    ownCapitalTied: (a) => ` · + ${a} de capital propio inmovilizado`,
    liveChronicle: "Actividad reciente",
    fullChronicle: "Actividad completa",
