...
export const REALM_UI: Record<QualityLang, RealmUiStrings> = {
  en: {
    ...
    oxygen: {
      ...
      produces: (perDay) => `today closings produce ${perDay} of net profit per day`,
    ...
    goalCurve: {
      aria: "Cumulative net profit against the required line",
      title: "Cumulative net profit · above or below the required line",
      legend: (era) =>
        `Booked net profit by month · the straight line the deadline requires · where today's pace lands, at the closed-lot average and${era ? ` at the since-${era} average` : " (no era average yet)"}`,
      today: "today",
    ...
    milestone: {
      ...
      caption: "of net profit recorded",
    },
    pageStates: {
  ...
  es: {
    ...
    oxygen: {
      ...
      produces: (perDay) => `hoy los cierres producen ${perDay} de utilidad neta al día`,
    ...
    goalCurve: {
      aria: "Utilidad neta acumulada frente a la línea requerida",
      title: "Utilidad neta acumulada · por encima o por debajo de la línea requerida",
      legend: (era) =>
        `Utilidad neta registrada por mes · la recta que exige la fecha límite · dónde aterriza el ritmo de hoy, al promedio de lotes cerrados y${era ? ` al promedio desde ${era}` : " (aún sin promedio de la era)"}`,
      today: "hoy",
    ...
    milestone: {
      ...
      caption: "de utilidad neta registrada",
    },
    pageStates: {
